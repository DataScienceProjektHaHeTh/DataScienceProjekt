...
We used AI language models as a development tool throughout this project.

### Our approach

Before each commit we checked our locally developed code with AI to ensure high software quality (comments, logic and simplifications) and also to find possible side effects which we wanted to fix before pushing anything.
